        ...
        <div className="grid md:grid-cols-3 gap-8">
          {products.slice(0, 3).map((product, index) => (
            ...
            >
              ...
              <div className="p-10 bg-white h-80 relative flex items-center justify-center ">
                {/* White border wrapper */}
                <div className="relative w-full h-80 p-8 rounded-md overflow-hidden bg-white flex items-center justify-center">
