...
const { createProduct, createReview, getProducts, getProductById, editProduct, deleteProduct, upload } = require('../controllers/product.controller')
const { AuthMiddleware, isAdmin } = require('../middleware/auth.middlware')

router.post('/create-product', AuthMiddleware, upload.array('images') , isAdmin, createProduct)
